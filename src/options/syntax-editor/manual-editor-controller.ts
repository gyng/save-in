import { pathLinesToNodes, pathNodesToLines } from "../path-editor/path-editor-model.ts";
...
export const createManualEditorState = (unsavedLabel: string | (() => string)) => {
  ...
  const setup = (id: string) => {
    ...
    const firstActionRow = actionRows[0] as HTMLElement;
    ...
    const firstStatus = statuses[0] as HTMLElement;
