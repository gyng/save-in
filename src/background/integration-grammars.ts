...
export const INTEGRATION_GRAMMARS: readonly IntegrationGrammar[] = [
  ...
  },
  {
    ...
    semantics: [
      ...
      "A rule may contain at most one capture or capturegroups clause, one fetch:, one rename:, one tab:, one exclude:, and one disabled: control.",
      ...
      "tab: close closes the source tab only after a Save In download starts. Automatic rules cannot carry this action.",
