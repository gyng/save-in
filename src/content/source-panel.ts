...
export const toggleSourcePanel = (
  ...
  style.textContent = `
    :host{--si-text:#1f2328;--si-panel-bg:#fff;--si-control-bg:#fff;--si-border:#b1b1b3;--si-subtle-border:#d7d7db;--si-row-border:#eee;--si-hover-bg:#f0f0f4;--si-source-hover-bg:#f0f6ff;--si-preview-bg:#eee;--si-muted:#737373;--si-meta:#555;--si-count-bg:#e7e7ea;--si-primary:#0060df;--si-accent:#0060df;--si-kind-other:#57606a;--si-kind-image:#8250df;--si-kind-video:#0969da;--si-kind-audio:#b45309;--si-kind-stream:#087f5b;--si-kind-document:#cf222e;--si-text-xs:12px;--si-text-base:14px;--si-text-lg:16px;all:initial;position:fixed;z-index:2147483647;isolation:isolate;inset:0 0 0 auto;width:min(360px,92vw);font:var(--si-text-base)/1.35 system-ui,sans-serif;color:var(--si-text);color-scheme:light;animation:si-in 110ms ease-out both}
    :host([data-theme=dark]){--si-text:#f9f9fa;--si-panel-bg:#2a2a2e;--si-control-bg:#38383d;--si-border:#737373;--si-subtle-border:#4a4a4f;--si-row-border:#4a4a4f;--si-hover-bg:#45454b;--si-source-hover-bg:#38383d;--si-preview-bg:#38383d;--si-muted:#b1b1b3;--si-meta:#d7d7db;--si-count-bg:#4a4a4f;--si-primary:#73afe8;--si-accent:#2f79bc;--si-kind-other:#626b75;--si-kind-image:#7057b5;--si-kind-video:#2f79bc;--si-kind-audio:#986020;--si-kind-stream:#3f7f62;--si-kind-document:#a64b55;color-scheme:dark}
